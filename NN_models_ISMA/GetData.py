...
fyA0p10 = np.concatenate((fData['force_A0p05'], yData['y_A0p05']), axis=1)
fyA0p15 = np.concatenate((fData['force_A0p05'], yData['y_A0p05']), axis=1)
fyA0p20 = np.concatenate((fData['force_A0p05'], yData['y_A0p05']), axis=1)
fyA0p25 = np.concatenate((fData['force_A0p05'], yData['y_A0p05']), axis=1)
fyA0p30 = np.concatenate((fData['force_A0p05'], yData['y_A0p05']), axis=1)
