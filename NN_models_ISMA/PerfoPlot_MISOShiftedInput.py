...
Calculating the performance of the MISO model with shifted input
Plotting the history of the MISO model with shifted input
...
hist = pd.read_csv('MISO_shiftedInput/Model8/hist8_1.csv', index_col=0)

Utrainset = pd.read_csv('Utrainshift.csv', header=None).to_numpy()
ftrainset = pd.read_csv('ftrainshift.csv', header=None).to_numpy()
Utestset = pd.read_csv('Utestshift.csv', header=None).to_numpy()
ftestset = pd.read_csv('ftestshift.csv', header=None).to_numpy()
...
model = tf.keras.models.load_model('MISO_shiftedInput/Model8/Model8_1',
                                   custom_objects=metric)
tf.keras.utils.plot_model(model, 'MISO_shiftedInput.png', rankdir='TB',
...
perfdata.to_csv('MISOshiftedInput_performancedata.txt')
